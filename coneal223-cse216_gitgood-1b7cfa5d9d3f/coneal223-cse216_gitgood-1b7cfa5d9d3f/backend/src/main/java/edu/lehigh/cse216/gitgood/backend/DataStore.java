...
//     private int mLikeCount; // LOOK @

//     //private boolean mLiked; // LOOK @
...
//         mCounter = 0;
//         mLikeCount = 0;
//         //mLiked = false; // starts false because the message is initially not liked 
//         mRows = new ArrayList<>();
//     }
// /**
...
//         int id = mCounter++;
//         DataRow data = new DataRow(id, content, 0);
//         mRows.add(id, data);
//         return id;
//     }
//         /**
...
//     // updating a message based on whether the user has liked the message 
//     // if(liked == true){
//     //     likecount++;
//     // } else {
//     //     likecount--;
...
//     //data.mTitle = title;
//     //data.mLikeCount = likecount;
//     data.mContent = content;
//     return new DataRow(data);
// }
// public synchronized DataRow updateOneLike(int id, int likecount) {
//     // Do not update if we don't have valid data
//     //if (content == null)
//     //    return null;
//     // Only update if the current entry is valid (not null)
...
//     return true;
// }
// // public synchronized boolean deleteOneLike(int id) {
// //     // Deletion fails for an invalid Id or an Id that has already been 
// //     // deleted
// //     if (id >= mRows.size())
// //         return false;
