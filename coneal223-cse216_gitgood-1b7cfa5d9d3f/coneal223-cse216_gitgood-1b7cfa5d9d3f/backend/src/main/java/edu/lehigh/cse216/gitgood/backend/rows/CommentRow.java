...
/**
 * CommentRow holds a row of information for a comment. This information consists of
 * a comment id, a poster id, a post id, a string for the comment text, a boolean for
...
public class CommentRow {
    ...
    /**
     * The creation date for this comment
     */
     ...
     */
    public CommentRow(int id, int user_id, int post_id, String content, boolean active, Date created) {
        this.id = id;
