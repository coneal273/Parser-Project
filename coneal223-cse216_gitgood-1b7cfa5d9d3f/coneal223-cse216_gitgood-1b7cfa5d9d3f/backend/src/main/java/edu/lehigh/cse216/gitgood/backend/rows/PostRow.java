...
public class PostRow {
     ...
     * @param active The boolean indicating if this post is active or disabled
     * @param created The creation date of this post
     */
    public PostRow(int id, int user_id, String content, int votes, ArrayList<CommentRow> comments, boolean active, Date created) {
        this.id = id;
