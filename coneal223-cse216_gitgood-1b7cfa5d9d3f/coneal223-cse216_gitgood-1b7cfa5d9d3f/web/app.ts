 ...
 */
const backendUrl = "https://pacific-shelf-79852.herokuapp.com";
class NewEntryForm {
  /**
  ...
  private onSubmitResponse(data: any) {
    ...
    if (data.mStatus === "ok") {
      newEntryForm.clearForm();
      mainList.refresh(); // not sure if this is working
    }
    ...
    // Handle other errors with a less-detailed popup message
      ...
      window.alert("2Unspecified error");
    }
  }
  ...
  private clickEdit(e: Event) {
    ...
    const doAjax = async () => {
      await fetch(`${backendUrl}/ideas/${id}`, {
        ...
        .catch((error) => {
          console.warn("Something went wrong.", error);
          window.alert("5Unspecified error");
        });
    };
...
class EditEntryForm {
  ...
  init(data: any) {
    ...
    // Handle other errors with a less-detailed popup message
      ...
      window.alert("6Unspecified error");
    }
  }
  ...
  submitForm() {
    ...
    const doAjax = async () => {
      await fetch(`${backendUrl}/ideas/${id}`, {
        ...
        .catch((error) => {
          console.warn("Something went wrong.", error);
          window.alert("7Unspecified error");
        });
    };
